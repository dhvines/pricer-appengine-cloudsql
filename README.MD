...
Pricer with Cloud SQL on Google App Engine Standard (Java 8)
============================================================
...
* Create a Cloud SQL (MySQL) database
...
To use vist: http://localhost:8181/
...
Replace the original Spring configuration with the following properties
